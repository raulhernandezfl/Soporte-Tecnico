        ...
        $sql = "SELECT 
                ...
                FROM
                    ...
                    t_persona AS persona ON asignacion.id_persona = persona.id_persona
                        INNER JOIN
                    t_cat_equipo AS equipo ON asignacion.id_equipo = equipo.id_equipo and asignacion.id_persona = '$idPersona'";
        $respuesta = mysqli_query($conexion, $sql);
?>
                        ...
                        <div class="col-sm-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul>
                                        <li><b>Marca:</b> <?php echo $mostrar['marca']; ?></li>
                                        <li><b>Modelo:</b> <?php echo $mostrar['modelo']; ?></li>
                                        <li><b>Color:</b> <?php echo $mostrar['color']; ?></li>
                                        <li><b>Memoria:</b> <?php echo $mostrar['memoria']; ?></li>
                                        <li><b>Disco Duro:</b> <?php echo $mostrar['discoDuro']; ?></li>
                                        <li><b>Procesador:</b> <?php echo $mostrar['procesador']; ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
